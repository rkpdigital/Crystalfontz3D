/*
 * FILE NAME: plan_arc.cpp - arc planning and motion execution
 *
 ...
 */
/*
 * PURPOSE: High level conversion from an arc to lines.
 *
 * NOTES:	This module actually contains some parts that belong in the canonical machine, 
