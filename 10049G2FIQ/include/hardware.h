 ...
 *    Allocated status bits for internal FIQ use.
 *
 */
...
#define ALL_CMDS    0x0000FF00  // Tenative place for commands to stop on event or increment count?? Shared with status insigned int??
