/*
 * FILE NAME: controller.h - exec controller and main dispatch loop
 *
...
#define INPUT_BUFFER_LEN 252			// text buffer size (255 max)
...
enum cmControllerState {				// manages startup lines
	...
	CONTROLLER_PROMPT,					// controller is active and ready for STDIN inputs
    CONTROLLER_WORKING,					// controller is active and Processing a Gcode file.
    CONTROLLER_EXIT					// controller has received an exit command.
	};
