/*
 * FILE NAME: stepper.h - stepper motor interface
 *
 * Copyright (c) 2014 Robert K. Parker
 *
 * This file was part of TinyG project
 *
 ...
 */
#define DDA_SUBSTEPS 100000UL		// 100,000 accumulates substeps to 6 decimal places
...
typedef struct stConfig {			// stepper configs
	...
	cfgMotor_t m[MOTORS];			// settings for motors 1-5
} stConfig_t;
...
typedef struct stPrepSingleton {
	...
	uint16_t dda_period;			// DDA or dwell clock period setting in CPU cycles, Unused.
