/*
 * FILE NAME: settings_3Dprint.h - 10049 generic printer settings
 *
 * Copyright (c) 2014 Robert K. Parker
 *
 * This file was part of the the TinyG project
 *
 ...
 */
 /*
 * PURPOSE: 	Printer specific default runtime settings.
 *
 * NOTES: 	The values in this file are the default settings that are loaded into a
 * 		virgin 0049G2.cfg file, and can be changed using the config commands.
...
#define M1_TRAVEL_PER_REV		31.416		// 1tr
...
#define M2_TRAVEL_PER_REV		31.416
...
#define M3_TRAVEL_PER_REV		31.416
...
#define Y_JERK_MAX 				100000		// 100 billion
