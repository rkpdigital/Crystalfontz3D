/*
 * report.h - Status report and other reporting functions
 *
...
#define CMD_STATUS_REPORT_LEN 30 	//  Was CMD_MAX_OBJECTS max number of status report elements - see cfgArray
