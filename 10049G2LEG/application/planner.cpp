/*
 * FILE NAME: planner.cpp - cartesian trajectory planning and motion execution
 *
 ...
 */
/*
 * PURPOSE: Cartesian trajectory planning and motion execution.
 *
 * NOTES:	The planner works below the canonical machine and above the motor
 *	mapping and stepper execution layers. A rudimentary multitasking capability
 *	is implemented for long-running commands such as lines, arcs, and dwells.
 ...
 * When the stepper driver sees a dwell it adds to the FIQ delay counter.
 */
